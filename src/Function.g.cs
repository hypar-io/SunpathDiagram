...
namespace SunpathDiagram
{
    public class Function
    {
        ...
        private IModelStore<SunpathDiagramInputs> store;

        public async Task<SunpathDiagramOutputs> Handler(SunpathDiagramInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<SunpathDiagramInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<SunpathDiagramInputs,SunpathDiagramOutputs>(store, SunpathDiagram.Execute);
